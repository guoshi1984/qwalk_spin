...
#ifndef SO_4D_VMC_METHOD_H_INCLUDED
#define SO_4D_VMC_METHOD_H_INCLUDED
...
*/
class SO_4D_Vmc_method : public Qmc_avg_method
{
public:
...
private:
  ...
  int evaluate_so; // 1 or 0, elvaluate spin oribt energy
  ...
  System * sysprop;
  Sample_point * sample;
  Array1 <SO_4D_Config_save_point> config_pos;
...
#endif //SO_4D_VMC_METHOD_H_INCLUDED
//------------------------------------------------------------------------
