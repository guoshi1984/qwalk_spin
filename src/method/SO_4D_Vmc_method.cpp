...
void SO_4D_Vmc_method::read(vector <string> words,
                      unsigned int & pos,
...
int SO_4D_Vmc_method::generateVariables(Program_options & options) {
...
int SO_4D_Vmc_method::allocateIntermediateVariables(System * locsys, 
...
int SO_4D_Vmc_method::deallocateIntermediateVariables() {
  if(wf) delete wf;
  wf=NULL;
...
int SO_4D_Vmc_method::showinfo(ostream & os)
{
...
void SO_4D_Vmc_method::readcheck(string & filename) {
  /*
  int configsread=0;
  ...
  if(config_pos.GetDim(0) < nconfig) { 
    Array1 <SO_4D_Config_save_point> tmpconfig=config_pos;
    config_pos.Resize(nconfig);
...
void SO_4D_Vmc_method::storecheck(string & filename, int append) {
...
//public function
void SO_4D_Vmc_method::run(Program_options & options, ostream & output) {
  if(!have_generated_variables) 
...
*/
//private function
void SO_4D_Vmc_method::runWithVariables(Properties_manager & prop, 
                                  System * sys, 
                                  ...
                                  ostream & output)
{
  ...
  //cout<<" use_spin_sample "<< use_spin_sample;
