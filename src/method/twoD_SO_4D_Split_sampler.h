...
#ifndef twoD_SO_4D_SPLIT_SAMPLE_H_INCLUDED
#define twoD_SO_4D_SPLIT_SAMPLE_H_INCLUDED
...
class twoD_SO_4D_Split_sampler:public Dynamics_generator {
 public:

  twoD_SO_4D_Split_sampler()  {
    divide_=1.0;
    recursion_depth_=1;
    restrict_nodes=0;
    dtype=drift_cyrus;
...
private:
  ...
  doublevar transition_prob(int point1, int point2,
                            doublevar timestep, 
                            drift_type dtype);
  void Norm(Array1 <doublevar> & omega);
...
#endif //2D_SO_4D_SPLIT_SAMPLE_H_INCLUDED
