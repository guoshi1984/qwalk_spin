...
#ifndef SO_SPLIT_SAMPLE_H_INCLUDED
#define SO_SPLIT_SAMPLE_H_INCLUDED
...
//define new point call it SO_point

struct SO_Point {
  Array1 <doublevar> drift; //dimension 4
  Array1 <doublevar> pos;  //dimension 3
  doublevar omega;
  doublevar sign;
  Wf_return lap;
  Array1 <doublevar> gauss;
  Array1 <doublevar> translation;
...
class SO_Split_sampler:public Dynamics_generator {
 public:
...
#endif //SO_SPLIT_SAMPLE_H_INCLUDED
