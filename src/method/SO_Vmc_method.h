...
#ifndef SO_VMC_METHOD_H_INCLUDED
#define SO_VMC_METHOD_H_INCLUDED
...
*/
class SO_Vmc_method : public Qmc_avg_method
{
public:
...
private:
  ...
  System * sysprop;
  Sample_point * sample;
  Array1 <SO_Config_save_point> config_pos;
...
#endif //SO_VMC_METHOD_H_INCLUDED
//------------------------------------------------------------------------
