 ...
 */
doublevar twoD_SO_Split_sampler::transition_prob(int point1, int point2,
                                         doublevar timestep, 
                                         drift_type dtype) {
  doublevar prob=0;
...
void twoD_SO_Split_sampler::read(vector <string> & words) {
  unsigned int pos=0;
 ...
 */
doublevar twoD_SO_Split_sampler::get_acceptance(Guiding_function * guidingwf
                                        ) {
  //indent = indent + "  ";
...
//----------------------------------------------------------------------
int twoD_SO_Split_sampler::split_driver(int e,
                                Sample_point * sample,
                                Wavefunction * wf, 
                                Wavefunction_data * wfdata,
                                Guiding_function * guidingwf,
...
int twoD_SO_Split_sampler::sample(int e,
                          Sample_point * sample, 
                          Wavefunction * wf, 
                          Wavefunction_data * wfdata,
                          Guiding_function * guidingwf,
...
void twoD_SO_Split_sampler::showStats(ostream & os) {
  doublevar totacc=0;
  for(int i=0; i< recursion_depth_; i++) {
...
void twoD_SO_Split_sampler::resetStats() {
  acceptances=0;
  tries=0;
}
