...
#ifndef SO_4D_HEG_SYSTEM_H_INCLUDED
#define SO_4D_HEG_SYSTEM_H_INCLUDED

#include "Qmc_std.h"
#include "System.h"
#include "Particle_set.h"
#include "Pbc_enforcer.h"
class SO_4D_HEG_sample;
...
public:
  ...
  void calcSpinOrbit(Wavefunction_data*, Sample_point*,
                    Wavefunction*, Array1 <doublevar> &);
...
private:
  ...
  */
  ...
  doublevar so_mag;
  doublevar (SO_4D_HEG_system::*calcLocChoice)(Sample_point *);
  ...
  */
  ...
  int setupEwald_2D(Array2 <doublevar> & crossProduct);  
  /*! \brief
  ...
  doublevar ewaldElectron_2D(Sample_point * sample);
  
  /*! \brief
    Initializations for truncated Coulomb evaluation
  */
  int setupTruncCoulomb(); 
  int setupTruncCoulomb_2D();
...
#endif //SO_4D_HEG_SYSTEM_H_INCLUDED
//----------------------------------------------------------------------
