...
int HEG_system::setupEwald_2D(Array2 <doublevar> & crossProduct) {
  //----Set up reciprocal Ewald sum
...
int HEG_system::setupTruncCoulomb_2D() {
  ...
  // backgr_trunc=1/V \int_{cell} 1/r
  // [ Mathematica helped with this one... ]
  doublevar backgr_trunc_single=3.52549442/L;
  backgr_trunc=totnelectrons*totnelectrons/2.0*backgr_trunc_single;
...
doublevar HEG_system::ewaldElectron_2D(Sample_point * sample) {
  sample->updateEEDist();
