...
#ifndef SO_4D_HEG_SAMPLE_H_INCLUDED
#define SO_4D_HEG_SAMPLE_H_INCLUDED
...
*/
class SO_4D_HEG_sample : public Sample_point
{
public:

  SO_4D_HEG_sample() { overall_sign=1.0; overall_phase=0.0; } 
  ~SO_4D_HEG_sample()
  {}
  ...
  */
  ...
  void setElectronOmega(const int e, const Array1<doublevar> & omega);
  void translateElectron(const int e, const Array1 <doublevar> & trans);
  
  void getElectronPos(const int e, Array1 <doublevar> & R);
  void getElectronOmega(const int e, Array1 <doublevar> & omega);
...
private:
  ...
  SO_4D_HEG_system * parent;     //The System that created this object
};



#endif //SO_4D_HEG_SAMPLE_H_INCLUDED
//-------------------------------------------------------------------------
