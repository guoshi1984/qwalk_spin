...
#ifndef POLY_PADE_FUNCTION_2D_H_INCLUDED
#define POLY_PADE_FUNCTION_2D_H_INCLUDED
...
*/
class Poly_pade_function_2D: public Basis_function
{
public:

  Poly_pade_function_2D()
  {}
  ~Poly_pade_function_2D()
  {}
...
#endif // POLY_PADE_FUNCTION_2D_H_INCLUDED
//--------------------------------------------------------------------------
