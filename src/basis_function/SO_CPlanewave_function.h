...
#ifndef SO_CPLANEWAVE_FUNCTION_H_INCLUDED
#define SO_CPLANEWAVE_FUNCTION_H_INCLUDED
...
*/
class SO_CPlanewave_function: public CBasis_function
{
public:

  SO_CPlanewave_function()
  {}
  ~SO_CPlanewave_function()
  {}

  //-----------------------------------------------------
  virtual void debug( const Array1 <doublevar> & r, const doublevar & omega, Array3 <dcomplex> & sysvals, const int startfill);
  virtual int read(
    vector <string> & words,
